...
- [x] 01-02-PLAN.md — Wire Tailwind v4 and the `@` alias, initialize shadcn/ui, generate the six primitives, and overlay the PinchPop brand tokens and self-hosted fonts
