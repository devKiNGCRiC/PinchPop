...
/** Three dashed frames waiting to be filled, then a nudge toward the next action. */
  ...
  return (
    <div className="mx-auto flex max-w-xl flex-col items-center text-center">
      <div aria-hidden="true" className="flex items-end justify-center gap-4">
        <div className="h-28 w-20 -rotate-6 rounded-md border-[2.5px] border-dashed border-ink bg-cloud/60 sm:h-36 sm:w-28" />
        <div className="h-32 w-24 rotate-2 rounded-md border-[2.5px] border-dashed border-ink bg-lemon/50 sm:h-44 sm:w-32" />
        <div className="h-28 w-20 rotate-6 rounded-md border-[2.5px] border-dashed border-ink bg-cloud/60 sm:h-36 sm:w-28" />
      </div>
